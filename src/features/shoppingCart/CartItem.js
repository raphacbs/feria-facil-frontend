...
import { putPostCartItem } from "./shoppingCartSlice";
...
const CartItem = (props) => {
  ...
  const onUpdate = async (cartItem) => {
    console.log("update", cartItem);
    dispatch(putPostCartItem(cartItem));
  };
      ...
      <HStack space={2}>
        <Checkbox
          ...
          onChange={async (state) => {
            onUpdate({ ...cartItem, isChecked: state });
          }}
          value="one"
        >
                ...
                <HStack space={3} justifyContent="flex-end">
                  <IconButton
                    ...
                    onPress={() => {
                      ...
                      onUpdate({ ...cartItem, amountOfProduct: value });
                    }}
                  />
